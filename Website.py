...
def guidelines_page():
    ...
    with st.container():
        st.markdown('<div class="main-content">', unsafe_allow_html=True)
        st.markdown(f"<h1 style='color: DodgerBlue; margin-top: 10px; margin-bottom: 10px; text-align: center;'>Welcome, {st.session_state.get('Name', 'User')}!</h1>", unsafe_allow_html=True)
        st.markdown("""
            <h2 style="color: Tomato; margin-top: 5px; margin-bottom: 5px; text-align: center;">📋 What is Alzheimer's Disease?</h2>
