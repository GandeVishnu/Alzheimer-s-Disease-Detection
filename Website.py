...
def guidelines_page():
    ...
    with st.container():
        st.markdown('<div class="main-content">', unsafe_allow_html=True)
        st.markdown(f"<h1 style='color: DodgerBlue; padding: 10px;'>Welcome, {st.session_state.get('Name', 'User')}!</h1>", unsafe_allow_html=True)
        st.markdown("""
            <h2 style="color: Tomato; padding: 5px;">📋 What is Alzheimer's Disease?</h2>
